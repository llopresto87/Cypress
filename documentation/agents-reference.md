...
- **model class:** `opus`
- **Delegation:** coordinator with `can_delegate: true`, `max_spawn_depth: 2`, `delegates_to:` `growth-scout`, `seed-installer`, `docs-librarian`, `architect`, `research-scout`, `tester`

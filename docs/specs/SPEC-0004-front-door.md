...
| PROSE_FLOOR_HELD_PER_FILE | test_prose_lint_one_step_per_file | tests/test_gate_registry.py | unit (scope), `expectedFailure` until increment 7 (markers removed at increment 7); C5 RED for the prose-lint step split | green |
| PROSE_FLOOR_HELD_PER_FILE | test_prose_lint_multi_file_refused | tests/test_gate_registry.py | unit (scope), `expectedFailure` until increment 7 (markers removed at increment 7) | green |
| PROSE_FLOOR_HELD_PER_FILE | test_prose_lint_same_name_refused | tests/test_gate_registry.py | unit (scope), `expectedFailure` until increment 7 (markers removed at increment 7) (AC-29) | green |
| PROSE_FLOOR_HELD_PER_FILE | test_prose_lint_other_argument_forms_refused | tests/test_gate_registry.py | unit (scope), added 2026-09-24 after review orchestrator.39: `--file=`, `--root` and `--glob` refused | green |
...
| PROSE_STEP_NAME_COLLISION | test_prose_lint_same_name_refused | tests/test_gate_registry.py | unit (scope), `expectedFailure` until increment 7 (markers removed at increment 7) | green |

...
|---|---|---|---|
| Regulation (EU) 2016/679 (**GDPR**) | regulation | [eu/gdpr.md](eu/gdpr.md) | core definitions, the Art. 5 principles, lawful bases and special categories, the data-subject rights block, controller/processor obligations, records, security, breach notification, DPIA, certification, the Chapter V transfer regime, and the Art. 87 national-identification-number enabling clause |
...
| **A29WP Opinion 05/2014** on anonymisation techniques (WP216) | supervisory guidance, predecessor body | [eu/a29wp-opinion-05-2014-anonymisation.md](eu/a29wp-opinion-05-2014-anonymisation.md) | the identifiability test and the three criteria an effective anonymisation must defeat (singling out, linkability, inference), why pseudonymisation is a security measure and not anonymisation, and the per-technique residual-risk table — **guidance, not binding law, adopted under the repealed predecessor Directive; its standing under the present Regulation is an open question the page records rather than settles** |
